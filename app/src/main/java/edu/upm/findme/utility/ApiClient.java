...
class ApiClientProtected extends AsyncHttpClient {
    ...
    protected ResponseHandler successHandlerBuilder(ApiClient.SuccessHandler handler) {
...
public class ApiClient extends ApiClientProtected {
    ...
    public void addUser(User user, UserAddHandler handler) {
    ...
    public interface UserAddHandler {
